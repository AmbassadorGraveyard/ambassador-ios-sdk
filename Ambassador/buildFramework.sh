#!/bin/sh
 ...
 #  then
      ...
      cp Users/distiller/Library/Developer/Xcode/DerivedData/*/Build/Intermediates/Ambassador.build/Release-iphoneos/Framework.build $CIRCLE_ARTIFACTS/Framework_files
#fi
