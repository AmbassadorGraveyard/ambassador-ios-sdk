...
NSString * const FACEBOOK_LOGO_IMAGE = @"facebook";
...
NSString * const TWITTER_LOGO_IMAGE = @"twitter";
...
NSString * const LINKEDIN_LOGO_IMAGE = @"linkedin";
...
NSString * const SMS_LOGO_IMAGE = @"sms";
...
NSString * const EMAIL_LOGO_IMAGE = @"email";
