...
@interface AMBFMResultSet : NSObject {
    AMBFMDatabase          *_parentDB;
    AMBFMStatement         *_statement;
...
@property (atomic, retain) AMBFMStatement *statement;
...
+ (instancetype)resultSetWithStatement:(AMBFMStatement *)statement usingParentDatabase:(AMBFMDatabase*)aDB;

/** Close result set */

- (void)close;

- (void)setParentDB:(AMBFMDatabase *)newDb;
