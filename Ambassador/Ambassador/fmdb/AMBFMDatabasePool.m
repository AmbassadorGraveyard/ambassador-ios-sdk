...
#import "AMBFMDatabasePool.h"
#import "AMBFMDatabase.h"

@interface AMBFMDatabasePool()

- (void)pushDatabaseBackInPool:(AMBFMDatabase*)db;
- (AMBFMDatabase*)db;

@end


@implementation AMBFMDatabasePool
...
- (AMBFMDatabase*)db {
    ...
    [self executeLocked:^() {
        ...
        if (db) {
            ...
            db = [AMBFMDatabase databaseWithPath:self->_path];
