 ...
 */
extern NSString *const AMBPTPusherEventReceivedNotification;

/** The key of the PTPusherEvent object in the PTPusherEventReceivedNotification userInfo dictionary.
 */
extern NSString *const AMBPTPusherEventUserInfoKey;
 ...
 */
extern NSString *const AMBPTPusherErrorDomain;
 ...
 * See: http://pusher.com/docs/pusher_protocol#error-codes
 */
extern NSString *const AMBPTPusherFatalErrorDomain;
 ...
 */
@interface AMBPTPusher : NSObject <PTPusherConnectionDelegate, PTPusherEventBindings>
 ...
 */
@property (nonatomic, weak) id<AMBPTPusherDelegate> delegate;
 ...
 */
@property (nonatomic, strong, readonly) AMBPTPusherConnection *connection;
