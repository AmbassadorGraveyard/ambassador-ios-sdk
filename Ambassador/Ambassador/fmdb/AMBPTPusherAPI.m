...
- (void)triggerEvent:(NSString *)eventName onChannel:(NSString *)channelName data:(id)eventData socketID:(NSString *)socketID
{
  ...
  NSData *bodyData = [[AMBPTJSON JSONParser] JSONDataFromObject:eventData];
  ...
  AMBPTURLRequestOperation *operation = [[AMBPTURLRequestOperation alloc] initWithURLRequest:request];
