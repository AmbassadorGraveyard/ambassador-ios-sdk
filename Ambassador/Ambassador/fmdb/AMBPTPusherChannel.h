 ...
 */
@interface AMBPTPusherChannel : NSObject <PTPusherEventBindings, AMBPTEventListener>
...
- (id)initWithName:(NSString *)channelName pusher:(AMBPTPusher *)pusher;
 ...
 */
@property (nonatomic, weak) id<AMBPTPusherPresenceChannelDelegate> presenceDelegate;
 ...
 *
 */
@interface AMBPTPusherChannelMember : NSObject
...
/** The client member.
 */
@property (nonatomic, readonly) AMBPTPusherChannelMember *me;
