...
NSString * const AMB_USER_EMAIL_DEFAULTS_KEY = @"AMBUSEREMAILSTORAGE";

NSString * const AMB_UNIVERSAL_TOKEN_DEFAULTS_KEY = @"AMBUNIVERSALTOKENSTORAGE";

NSString * const AMB_UNIVERSAL_ID_DEFAULTS_KEY = @"AMBUNIVERSALIDSTORAGE";

NSString * const AMB_CAMPAIGN_ID_DEFAULTS_KEY = @"AMBCAMPAIGNIDDSTORAGE";
