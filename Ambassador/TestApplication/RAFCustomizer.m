...
- (NSData *)getJavaXMLFile {
    ...
    [xmlFileString appendString:[NSString stringWithFormat:@"    <string name=\"RAFdefaultShareMessage\">Check out this company!</string>\n"]];
    ...
    [xmlFileString appendString:[NSString stringWithFormat:@"    <string name=\"RAFLogoPosition\">1</string>\n"]];
    [xmlFileString appendString:[NSString stringWithFormat:@"    <string name=\"RAFLogo\">%@.png</string>\n", self.rafItem.rafName]];
    [xmlFileString appendString:[NSString stringWithFormat:@"    <string name=\"RAFdescriptionText\">%@</string>\n", textValue2]];
    [xmlFileString appendString:[NSString stringWithFormat:@"    <color name=\"homeBackground\">#FFFFFF</color>\n"]];
    [xmlFileString appendString:[NSString stringWithFormat:@"    <color name=\"homeWelcomeTitle\">%@</color>\n", textColorString1]];
    [xmlFileString appendString:[NSString stringWithFormat:@"    <dimen name=\"homeWelcomeTitle\">22sp</dimen>\n"]];
    [xmlFileString appendString:[NSString stringWithFormat:@"    <string name=\"homeWelcomeTitle\">sans-serif</string>\n"]];
    [xmlFileString appendString:[NSString stringWithFormat:@"    <color name=\"homeWelcomeDesc\">%@</color>\n", textColorString2]];
    [xmlFileString appendString:[NSString stringWithFormat:@"    <dimen name=\"homeWelcomeDesc\">18sp</dimen>\n"]];
    [xmlFileString appendString:[NSString stringWithFormat:@"    <string name=\"homeWelcomeDesc\">sans-serif</string>\n"]];
    ...
    [xmlFileString appendString:[NSString stringWithFormat:@"    <string name=\"homeToolBarText\">sans-serif</string>\n"]];
    [xmlFileString appendString:[NSString stringWithFormat:@"    <color name=\"homeToolBarArrow\">#FFFFFF</color>\n"]];
    [xmlFileString appendString:[NSString stringWithFormat:@"    <color name=\"homeShareTextBar\">#EBEBEB</color>\n"]];
    [xmlFileString appendString:[NSString stringWithFormat:@"    <color name=\"homeShareText\">#B3B3B3</color>\n"]];
    [xmlFileString appendString:[NSString stringWithFormat:@"    <dimen name=\"homeShareText\">12sp</dimen>\n"]];
    [xmlFileString appendString:[NSString stringWithFormat:@"    <string name=\"homeShareText\">sans-serif</string>\n"]];
    [xmlFileString appendString:[NSString stringWithFormat:@"    <string name=\"socialGridText\">sans-serif</string>\n"]];
    [xmlFileString appendString:[NSString stringWithFormat:@"    <dimen name=\"socialOptionCornerRadius\">0dp</dimen>\n"]];
    [xmlFileString appendString:[NSString stringWithFormat:@"    <array name=\"channels\">\n"]];
    [xmlFileString appendString:androidSocialArrayString];
    [xmlFileString appendString:[NSString stringWithFormat:@"    </array>\n"]];
    [xmlFileString appendString:[NSString stringWithFormat:@"    <color name=\"contactsListViewBackground\">#FFFFFF</color>\n"]];
    [xmlFileString appendString:[NSString stringWithFormat:@"    <dimen name=\"contactsListName\">15sp</dimen>\n"]];
    [xmlFileString appendString:[NSString stringWithFormat:@"    <string name=\"contactsListName\">sans-serif</string>\n"]];
    [xmlFileString appendString:[NSString stringWithFormat:@"    <dimen name=\"contactsListValue\">12sp</dimen>\n"]];
    [xmlFileString appendString:[NSString stringWithFormat:@"    <string name=\"contactsListValue\">sans-serif</string>\n"]];
    [xmlFileString appendString:[NSString stringWithFormat:@"    <color name=\"contactsSendBackground\">#FFFFFF</color>\n"]];
    [xmlFileString appendString:[NSString stringWithFormat:@"    <string name=\"contactSendMessageText\">sans-serif</string>\n"]];
    [xmlFileString appendString:[NSString stringWithFormat:@"    <color name=\"contactsToolBar\">#3C97D3</color>\n"]];
    [xmlFileString appendString:[NSString stringWithFormat:@"    <color name=\"contactsToolBarText\">#FFFFFF</color>\n"]];
    [xmlFileString appendString:[NSString stringWithFormat:@"    <color name=\"contactsToolBarArrow\">#FFFFFF</color>\n"]];
    [xmlFileString appendString:[NSString stringWithFormat:@"    <color name=\"contactsSendButton\">%@</color>\n", buttonColorString]];
    [xmlFileString appendString:[NSString stringWithFormat:@"    <color name=\"contactsSendButtonText\">#FFFFFF</color>\n"]];
    [xmlFileString appendString:[NSString stringWithFormat:@"    <color name=\"contactsDoneButtonText\">#3C97D3</color>\n"]];
    [xmlFileString appendString:[NSString stringWithFormat:@"    <color name=\"contactsSearchBar\">#000000</color>\n"]];
    [xmlFileString appendString:[NSString stringWithFormat:@"    <color name=\"contactsSearchIcon\">#FFFFFF</color>\n"]];
